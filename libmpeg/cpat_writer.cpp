...
namespace libmedia_transfer_protocol
{
	namespace libmpeg
	{
		void PatWriter::WritePat(StreamWriter * w)
		{
			...
			libmedia_transfer_protocol::ByteWriter<uint16_t>::WriteBigEndian(q, program_number_);
			 
			q += 2;
			libmedia_transfer_protocol::ByteWriter<uint16_t>::WriteBigEndian(q, 0XE000 | pmt_pid_);
