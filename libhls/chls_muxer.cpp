...
namespace libmedia_transfer_protocol {
	namespace libhls
	{
		HLSMuxer::HLSMuxer(const std::string &session_name)
			//:stream_name_(name)
		{
			//auto list = tmms::base::StringUtils::SplitString(session_name, "/");
		...
		void HLSMuxer::ParseCodec(FragmentPtr & fragment, std::shared_ptr<libmedia_transfer_protocol::libmpeg::Packet>&packet)
		{
